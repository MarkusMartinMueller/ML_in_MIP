...
case_list = ["A001", "A006", "A003", "A130_R", "A005"]
...
params = {
    ...
    "model_name": "MonaiUnet",  # "resnet", "preresnet", "wideresnet", "densenet", "simpleCNN", "ClassificationModel3D", "CNN3DSoftmax", "CNN3DMoboehle", "CNN3DTutorial", "LinearModel3D",
    # "model_depth": 10, # 10
    # "resnet_shortcut": 'B',
    "optimizer_momentum": 0.9,
    "optimizer": "Adam",
    "criterion": "CrossEntropyLoss",  #'BCEWithL ogitsLoss',
